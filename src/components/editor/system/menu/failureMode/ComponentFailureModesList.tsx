        ...
        <Box>
            ...
            <Box>
              {componentFailureModes.map((fm) => (
                <ListItem key={fm.iri}>
                  ...
                  <ListItemSecondaryAction>
                    <IconButton className={classes.actionButton} onClick={() => showEditForm(fm)} size="large">
                      <Edit />
                    </IconButton>
                    <IconButton className={classes.actionButton} onClick={() => handleDeleteFunction(fm)} size="large">
                      <DeleteIcon />
                    </IconButton>
                  </ListItemSecondaryAction>
                </ListItem>
          ...
          <Dialog open={dialog} onClose={closeDialogWindow} fullWidth maxWidth="sm">
              ...
              <SafeAutocomplete
                ...
                getOptionLabel={(option) => {
                  ...
                  return (
                    failureMode.name +
                    " (" +
                    (failureMode.component == null ? "None" : failureMode.component.name) +
                    ")"
                  );
                }}
                fullWidth
            ...
            <DialogActions>
              ...
              <Button color="primary" onClick={handleAddExistingFM}>
                Add
              </Button>
            </DialogActions>
          </Dialog>
