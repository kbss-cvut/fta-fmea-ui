...
const ComponentContextMenu = ({
  ...
  return (
    ...
    >
      <MenuItem key="component-create" onClick={handleCreateClick}>
        Create
      </MenuItem>

      {createOnly && (
        <MenuItem key="component-import" onClick={handleImportClick}>
          Import document
        </MenuItem>
      )}
      {!createOnly && (
        <MenuItem key="component-delete" onClick={handleDeleteClick}>
          Delete
        </MenuItem>
      )}
      {!createOnly && (
        <MenuItem key="component-source" onClick={handleGoToSource}>
          {" "}
          Go to source
        </MenuItem>
      )}
      {mergeable && (
        <MenuItem key="component-merge" onClick={handleMergeClick}>
          {" "}
