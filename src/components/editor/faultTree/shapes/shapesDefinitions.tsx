...
const Event = joint.dia.Element.define('fta.Event', {
    z: 3,
    attrs: {
        root: {
...
export const ExternalEvent = Event.define('fta.ExternalEvent', {
    size: {
        width: 80,
        height: 100
    },
...
export const UndevelopedEvent = Event.define('fta.UndevelopedEvent', {
    size: {
        width: 140,
        height: 80
    },
...
export const BasicEvent = Event.define('fta.BasicEvent', {
    size: {
        width: 80,
        height: 80
    },
...
export const ConditioningEvent = Event.define('fta.ConditioningEvent', {
    size: {
        width: 140,
        height: 80
    },
...
export const Link = joint.dia.Link.define('fta.Link', {
    attrs: {
        line: {
            connection: true,
            stroke: '#333333',
