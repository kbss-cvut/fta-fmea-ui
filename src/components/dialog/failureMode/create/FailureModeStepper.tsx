...
const FailureModeStepper = ({
  ...
  const handleSteps = (step) => {
    switch (step) {
      case 0:
        return (
          <FailureModeCreationStep failureMode={selectedFailureMode} onFailureModeChanged={setSelectedFailureMode} />
        );
      case 1:
        return (
          <ComponentsProvider>
            <ComponentPicker selectedComponent={selectedComponent} onComponentSelected={handleComponentSelected} />
          </ComponentsProvider>
        );
      case 3:
        return <FailureModeStepperConfirmation component={selectedComponent} failureMode={selectedFailureMode} />;
      default:
        break;
    }
  };
      ...
      case 0:
        return (
          <div className={classes.navigationButtonsDiv}>
            <Button variant="contained" color="primary" onClick={handleNext} disabled={!nextButtonEnabled(step)}>
              Next
            </Button>
          </div>
        );
      case stepTitles.length - 1:
        return (
          <div className={classes.navigationButtonsDiv}>
            ...
            <Button color="primary" onClick={handleConfirmClicked}>
              {buttonTitle}
            </Button>
          </div>
        );
